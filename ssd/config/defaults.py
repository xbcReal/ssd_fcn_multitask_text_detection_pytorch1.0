...
_C.MODEL.PRIORS.ROTATE_THATA_RANGE = [-0.7853982,0.7853982]
_C.MODEL.PRIORS.DIVIDED_NUM = 6
# match default boxes to any ground truth with distance smaller than a threshold
_C.MODEL.PRIORS.DISTANCE_THRESHOLD = [0.1, 0.15, 0.3, 0.45, 0.6, 0.75, 0.9]
