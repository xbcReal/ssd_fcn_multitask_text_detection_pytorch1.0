...
def run_demo(cfg, checkpoint_file, iou_threshold, score_threshold, images_dir, output_dir):
    ...
    submit_path = MyZip('/home/binchengxiong/ssd_fcn_multitask_text_detection_pytorch1.0/demo/result223'+str(min_epoch)+'/txtes', epoch)
...
def main():
    ...
    for model in models:
        ...
        parser.add_argument("--images_dir", default='/home/binchengxiong/ocr_data/ICDAR2015/ch4_training_images', type=str, help='Specify a image dir to do prediction.')
        #parser.add_argument("--images_dir", default='/home/binchengxiong/ocr_data/ICDAR2015/temp', type=str, help='Specify a image dir to do prediction.')
        parser.add_argument("--output_dir", default='demo/result223'+str(min_epoch), type=str,
